...
public class RespaldoBD implements ActionListener{
    ...
    /*public void respaldarBaseDeDatos() {
        ...
        try {
            ...
            if (completado && proceso.exitValue() == 0) {
                ...
                // Leer salida de error compatible con Java 8
    ...
    public void cargarBaseDeDatos() {
        ...
        pb.redirectErrorStream(true); // combinar salida de error con salida estándar

        try {
            Process proceso = pb.start();

            // Escribir el contenido del archivo .sql al proceso
