...
public class Diezmo {
    ...
    public Diezmo(int iddiezmo, int idlider, String tesorero, String carnet, String mes, Double entrada, Double salida, Double saldoanterior, Double saldoactual, String descripcion, Date fecharegistro) {
